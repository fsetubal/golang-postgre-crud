...
func createRandomProduct(t *testing.T) Product {
	...
	require.NotEmpty(t, product.CreateAt)
...
func TestGetProduct(t *testing.T) {
	...
	require.Equal(t, productRandomCreated.CreateAt, productFinded.CreateAt)
...
func TestUpdateProduct(t *testing.T) {
	...
	require.Equal(t, productRandomCreated.CreateAt, productUpdated.CreateAt)
}
